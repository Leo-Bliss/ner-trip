#!/usr/bin/env python
# -*- coding:utf-8 -*-
# @Time    :    2021/4/27 0027 15:34
# @Author  :    tb_youth
# @FileName:    page_table.py
# @SoftWare:    PyCharm
...
class TableWidget(QWidget):
    ...
    def __init_ui(self):
        style_sheet = """QTableWidget {border: none;background-color:rgb(240,240,240)} 
        QPushButton{max-width: 18ex;max-height: 6ex;font-size: 11px;} 
        QLineEdit{max-width: 30px}   """
...
class MainWindow(QMainWindow):
    ...
    def page_controller(self, signal):
        ...
        if "home" == signal[0]:
            ...
            return self.table_widget.curPage.setText(str(int(signal[1]) + 1))
        elif "final" == signal[0]:
